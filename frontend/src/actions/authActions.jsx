...
export const login = (email, password) => async dispatch => {
    ...
    try {
        const res = await axios.post('https://hogwartsedx-api-26jun.onrender.com/api/auth/login', body, config);
...
export const register = formData => async dispatch => {
    ...
    try {
        const res = await axios.post('https://hogwartsedx-api-26jun.onrender.com/api/auth/register', formData, config);
        const { token, user } = res.data;
...
export const acceptPolicy = () => async dispatch => {
    try {
        const res = await axios.post('https://hogwartsedx-api-26jun.onrender.com/api/auth/accept-policy');
        const { user } = res.data;
